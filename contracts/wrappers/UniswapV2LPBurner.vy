...
killed_coin: public(HashMap[uniERC20, bool])
...
@external
def burn_amount(_coin: uniERC20, _amount_to_burn: uint256):
    """
...
@external
@pure
def burns_to(_coin: uniERC20) -> DynArray[address, 8]:
    """
...
@external
def set_killed(_is_killed: bool, _coin: uniERC20=empty(uniERC20)):
    """
